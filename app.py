# -*- coding: utf-8 -*-
"""
Created on Tue Apr 20 11:04:44 2021
...
class Weather():
        ...
        def weather_report(self):
                ...
                self.url = "http://api.openweathermap.org/data/2.5/weather?q=Valkeakoski,Finland"
                self.cityname =  self.loc.get(1.0,END)
                self.api_key = 'd06c490037444511f4b9f40c91b918df'
        ...
        def __init__(self):
                ...
                self.location = Label(self.root,text="Valkeakoski",bg="#00274c",fg="white",font=self.font)
